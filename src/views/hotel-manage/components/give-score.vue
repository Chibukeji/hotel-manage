    ...
    <div>
        <el-dialog :visible.sync="scoreDialogVisible" :title="propData.title +'-赠送专属积分'" class="right-dialog" custom-class="left" width="60%">
            <div class="filter-container">
                ...
                <el-button v-if="btnAry.findIndex(x => x.id == '135')!=-1" class="filter-item" type="primary" size="mini" @click="handleRecharge">充值</el-button>
            </div>
            <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%;">
                ...
                <el-table-column label="会员" align="left" :show-overflow-tooltip="true" width="200">
                    <template slot-scope="{row}">
