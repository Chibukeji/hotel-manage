      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="收益" name="second">
            ...
            <el-table :data="teamCommissionList" v-loading="listLoading2" border fit highlight-current-row style="width: 100%;">
                ...
                <el-table-column label="预定酒店" align="center">
                    <template slot-scope="{row}">
...
<script>
import { getMemberTeamList,   getMemberTeamOrderList, getMemberTeamCommissionList } from '@/api/member-manage/member-list'
...
export default {
  ...
  methods: {
    ...
    memberTeamCommissionList(){
        ...
        let params={
            member_id:this.detailItem.id,
            keyword:this.listQuery2.keyword,
