...
export function rechargeScore(data) {
  return request({
    url: '/merch/hotel/giveExclusiveScore',
    method: 'post',
    data
  })
}
...
export function getHotelQrcode(data) {
  return request({
    url: '/merch/hotel/getHotelQrcode',
    method: 'get',
    params: data
  })
}