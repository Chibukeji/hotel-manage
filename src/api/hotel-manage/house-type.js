...
export function getRoomAttr(data) {
    return request({
      url: '/merch/hotel_room/getRoomAttr',
      method: 'get',
      params: data
    })
}
...
export function getRoomPriceList(data) {
    return request({
      url: '/merch/hotel_room_price/list',
      method: 'get',
      params: data
    })
}
...
export function getRoomPriceAdd(data) {
    return request({
        url: '/merch/hotel_room_price/add',
        method: 'post',
        data
    })
}
...
export function getRoomPriceEdit(data) {
    return request({
        url: '/merch/hotel_room_price/update',
        method: 'post',
        data
    })
}
...
export function getRoomPriceDel(data) {
    return request({
        url: '/merch/hotel_room_price/delete',
        method: 'get',
        params: data
    })
}